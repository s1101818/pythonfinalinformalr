...
def main(args):
    ...
    # wandb
        ...
        if not connected_to_internet():
            ...
            #3with open(os.path.expanduser("~") + "/keys.json") as json_file:
                #3key = json.load(json_file)
                #3my_wandb_api_key = key["my_wandb_api_key"]  # NOTE change here as well
            ##os.environ["WANDB_API_KEY"] = my_wandb_api_key
            ##os.environ["WANDB_MODE"] = "dryrun"
            ##3s.environ["WANDB_SAVE_CODE"] = "true"
