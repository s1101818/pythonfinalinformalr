...
def get_config():
    ...
    parser.add_argument(
        "--experiment_name",
        type=str,
        default="informarl_25",
        help="an identifier to distinguish different experiment.",
    )
    parser.add_argument(
        "--seed", type=int, default=2, help="Random seed for numpy/torch"
    )
    parser.add_argument(
        "--cuda",
        action="store_false",
    ...
    parser.add_argument(
        "--use_ReLU", action="store_false", default=False, help="Whether to use ReLU"
    )
    parser.add_argument(
        "--use_popart",
        action="store_true",
    ...
    # optimizer parameters
    parser.add_argument(
        "--lr", type=float, default=0.0007, help="learning rate (default: 5e-4)"
    )
    parser.add_argument(
        "--critic_lr",
        type=float,
